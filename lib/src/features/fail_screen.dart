...
class AppFailToastScreen extends StatefulWidget {
  const AppFailToastScreen({
    super.key,
    required this.image,
    required this.title,
  ...
  @override
  State<AppFailToastScreen> createState() => _AppFailToastScreenState();
}

class _AppFailToastScreenState extends State<AppFailToastScreen>
